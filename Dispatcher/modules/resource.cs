...
namespace Dispatcher.Modules
{
    public class CResource
    {
        ...
        private void insert(List<CElement> obj)
        {
            Dictionary<string, object> param = new Dictionary<string, object>();
            param.Add("operation", OperateType.add.ToString());
            param.Add(m_Opcode.ToString() + "s", new List<CElement>(obj));

            Request(m_Opcode, OperateType.add, param);
        }
        private void update(List<CElement> obj)
        {
            Dictionary<string, object> param = new Dictionary<string, object>();
            ...
            foreach (CElement objitem in obj)
            {
