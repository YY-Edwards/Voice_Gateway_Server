...
namespace TrboX
{
    ...
    class JsonParse
    {
        ...
        public static string Op2Json(RequestType request, object obj, TargetSystemType type)
        {
            PackageNumber++;

            RequestRadio req = new RequestRadio() { call = request.ToString(), type = type.ToString(),  callId = PackageNumber, param = obj };
            return JsonConvert.SerializeObject(req) + "\r\n";
        }
    }
}
