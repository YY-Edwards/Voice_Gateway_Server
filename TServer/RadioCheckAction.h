...
void radioCheckAction(CRemotePeer* pRemote, const std::string& param, uint64_t callId, const std::string& type)
{
	...
	try{
		...
		std::string callCommand = CRpcJsonParser::mergeCommand("radioCheck", callId, param.c_str());
		...
		//	std::string callJsonStr = CRpcJsonParser::buildCall("radioCheck", clientCallId, args);
