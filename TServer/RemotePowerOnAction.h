...
void remotePowerOnAction(CRemotePeer* pRemote, const std::string& param, uint64_t callId, const std::string& type)
{
	...
	try{
		...
		std::string callCommand = CRpcJsonParser::mergeCommand("remotePowerOn", callId, param.c_str());
		...
		//	std::string callJsonStr = CRpcJsonParser::buildCall("remotePowerOn", clientCallId, args);
