...
void recvConnetResultAction(CRemotePeer* pRemote, const std::string& param, uint64_t callId, const std::string& type)
{
	...
	try{
		...
		std::string callCommand = CRpcJsonParser::mergeCommand("connectStatus", callId, param.c_str(), type.c_str());
